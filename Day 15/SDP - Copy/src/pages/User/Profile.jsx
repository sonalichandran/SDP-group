...
const Profile = () => {
  ...
  return (
    <>
      <p className="text-center font-bold pt-8 pl-80 text-lg flex">Keep Your Profile Updated, user</p>
    <div className="w-screen pt-16 pl-64 flex">
      ...
      <p className="text-2xl font-bold mb-6 text-center text-green-600">User Details</p>
        <div className="mb-4 flex items-center">
          <label className="w-32 text-gray-700">Username</label>
          <input
            type="text"
